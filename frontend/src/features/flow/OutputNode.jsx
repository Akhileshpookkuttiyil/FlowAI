...
export default function OutputNode({ data }) {
  return (
    <div style={{ background: '#fafafa', border: '1px solid #e5e7eb', borderRadius: '6px', padding: '16px', width: '320px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03)', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ background: '#fff', fontSize: '14px', minHeight: '100px', padding: '12px', borderRadius: '4px', border: '1px solid #e5e7eb', whiteSpace: 'pre-wrap', color: data.value ? '#1f2937' : '#9ca3af', lineHeight: '1.5', position: 'relative' }}>
        {data.isLoading ? (
